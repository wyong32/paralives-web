<template>
  ...
  >
    ...
    <ul>
      ...
      <li>Quote brief excerpts with clear attribution and a link to the source page</li>
    </ul>
    <p>
      You may not republish full articles, scrape the Site for competing databases, or use our
      branding in a way that suggests endorsement without written permission.
    </p>

    <h2>Paralives and Game Materials</h2>
    <p>
      Paralives, Parafolks, Paramaker, Build Mode, Live Mode, and related names, logos, screenshots,
      and in-game icons are the property of Paralives Studio and/or their licensors. We display
      certain game icons and reference mechanics under fair use for educational and informational
      purposes. We do not claim ownership of game assets.
    </p>

    <h2>Third-Party and Community Content</h2>
    <p>
    ...
    <p>
      ...
      licenses. We credit sources where required.
    </p>
    ...
    <ol>
      ...
      <li>URL of the material on our Site</li>
      <li>Your contact information and a good-faith statement of infringement</li>
    ...
    <h2>Updates</h2>
    <p>
      We may revise this Copyright page as the Site grows. Check the last updated date for the current
      version.
    </p>
  </LegalPageLayout>
</template>
